$(function(){
	...
	$("footer").prepend('<div class="Foot_Top"><div class="Foot_Top_Left"><div><img src="images/header/phone.png" alt="深圳市新亚恒利科技有限公司"><span>全国客服热线：400-884-5500</span></div><div>地址：深圳市宝安区新安街道海裕社区N16区御景湾2栋玉林路5-17号(B103)B</div></div><div class="Foot_Top_Right"><div><img src="images/header/QrCode_wx.jpg" alt="深圳市新亚恒利科技有限公司"><div>关注官方微信公众号</div></div><div><img src="images/header/QrCode_app.png" alt="深圳市新亚恒利科技有限公司"><div>下载官方卖货易APP</div></div></div><div class="Foot_Top_Center"></div></div>');

	$(".Foot_Bottom").prepend('<span class="pc_banquan">2017-2018 k56.kaidongyuan.com/CYSCMAPP/official_web_gxsd 深圳市新亚恒利科技有限公司（C）版权所有&nbsp;&nbsp;</span><span class="m_banquan">2017-2018  凯东源城配（C）版权所有&nbsp;&nbsp;</span><span>&nbsp;&nbsp;<a href="http://www.beian.miit.gov.cn">粤ICP备15045744号</a>&nbsp;&nbsp;</span>&nbsp;&nbsp;')
...
function addHtml(bigImg,first,second,third,listData,titleText,now_start_use){
	$(".container").append('' +
		...
		'<div class="contain_bottom">' +
		            ...
		            '<div class="left_top">' +
		                '<div class="about_kdy">' +
		                    '<div class="about_top">' +
		                        ...
		                        '<span>' + second + '</span>' +
		                    '</div>' +
		                    '<div class="about_bottom">' + third + '</div>' +
		                '</div>' +
		            '</div>' +
		            '<ul>' + listData + '</ul>' +
		        '</div>' +
		    ...
		    '<div class="bottom_right">' +
			    '<div class="content_head"><h2>' + titleText + '</h2></div>' +
		        '<div class="now-start-use">' + now_start_use + '</div>' +

		        /* 下载图标 */
	            '<div class="Download_container">' +
					'<div class="Download_item">' +
						'<div class="Download_item_able_use Download_item_able_use_1">' +
							'<img class="Download_item_img" src="images/index/i/iOS.png">' +
							'<div class="Download_item_text">iOS版</div>' +
						'</div>' +
				    '</div>' +
					'<div class="Download_item">' +
						'<div class="Download_item_able_use Download_item_able_use_2">' +
							'<img class="Download_item_img" src="images/index/i/android.png">' +
							'<div class="Download_item_text">Android版</div>' +
						'</div>' +
				    '</div>' +
					'<div class="Download_item">' +
						'<div class="Download_item_able_use Download_item_able_use_3">' +
							'<img class="Download_item_img" src="images/index/i/qrcode.png">' +
							'<div class="Download_item_text">二维码下载</div>' +
						'</div>' +
				    '</div>' +
				'</div>' +
