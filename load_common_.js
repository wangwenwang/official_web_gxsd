$(function(){
	...
	$("footer").prepend('<div class="Foot_Top"><div class="Foot_Top_Left"><div><img src="images/header/phone.png" alt="飞读速思教育科技（深圳）有限公司"><span>全国客服热线：18928456377</span></div><div>地址：深圳市宝安区宝源路互联网产业基地A区7610</div></div><div class="Foot_Top_Right"><div><img src="images/header/QrCode_wx.jpg" alt="飞读速思教育科技（深圳）有限公司"><div>关注官方微信公众号</div></div><div><img src="images/header/QrCode_app.png" alt="飞读速思教育科技（深圳）有限公司"><div>下载官方卖货易APP</div></div></div><div class="Foot_Top_Center"></div></div>');

	$(".Foot_Bottom").prepend('<span class="pc_banquan">2017-2021 www.gxsd.mobi 飞读速思教育科技（深圳）有限公司（C）版权所有&nbsp;&nbsp;</span><span class="m_banquan">2017-2021  凯东源城配（C）版权所有&nbsp;&nbsp;</span><span>&nbsp;&nbsp;<a href="http://www.beian.miit.gov.cn">粤ICP备19160643号-1</a>&nbsp;&nbsp;</span>&nbsp;&nbsp;')
